    ...
    add: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    customer_id = (req === null || req === void 0 ? void 0 : req.userData).customer_id;
                    return [4 /*yield*/, db_1.default.query("insert into customer_address values (" + customer_id + ",'" + req.body.alamat + "','" + req.body.kode_pos + "',DEFAULT,'" + req.body.name + "'," + req.body.kelurahan_id + ")")];
                case 1:
                    data = _a.sent();
